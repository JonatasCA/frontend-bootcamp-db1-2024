describe('login', () => {
  it('should login with success', () => {
    ...
    cy.get('.ant-menu-item-selected > .ant-menu-title-content').should('contain', 'Minhas tarefas');
  ...
  it('should fail the login with wrong user or password', () => {
    ...
    cy.get('.ant-modal-confirm-title').should('contain', 'Usuário ou senha inválidos');
